...
// private static final int mAlphaOffset = 50;
    ...
    public DivergeViewSecond(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public DivergeViewSecond(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
