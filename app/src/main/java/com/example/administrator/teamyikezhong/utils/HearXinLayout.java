package com.example.administrator.teamyikezhong.utils;
...
/**
 * Created by 兰昊琼 on 2018/6/10.
 */


public class HearXinLayout extends RelativeLayout implements  View.OnClickListener {
   private ConstractsPathAnimator mAnimator;
    ...
    public HearXinLayout(Context context) {
        super(context);
        findViewById(context);
    }

    public HearXinLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.attrs = attrs;
        findViewById(context);
    }

    public HearXinLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public class HeartHandler extends Handler {
        ...
        WeakReference<HearXinLayout> wf;

        public HeartHandler(HearXinLayout layout) {
            wf = new WeakReference<HearXinLayout>(layout);
        }
    }
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        mAnimator = new PathAnimator(ConstractsPathAnimator.Config.fromTypeArray(a, initX, textHight, pointx, dWidth, dHeight));
        a.recycle();
    }
    @Override
    ...
    public ConstractsPathAnimator getAnimator() {
        return mAnimator;
    }

    public void setAnimator(ConstractsPathAnimator animator) {
        clearAnimation();
        mAnimator = animator;
    }
